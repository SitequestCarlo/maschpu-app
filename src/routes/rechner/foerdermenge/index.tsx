    ...
    <div class={styles.tool}>
      ...
      <div class={styles.result}>
        ...
        <div>
          ...
          <span><b>{Math.max(m3s.value * 1000, 0).toFixed(2)}</b> l/s</span>
        </div>

        <div>
          <span>l/min (Liter/Minute)</span>
          <span><b>{Math.max(m3s.value * 60000, 0).toFixed(2)}</b> l/min</span>
        </div>

        <div>
          <span>l/h (Liter/Stunde)</span>
          <span><b>{Math.max(m3s.value * 3600000, 0).toFixed(2)}</b> l/h</span>
        </div>
        ...
        <div>
          ...
          <span><b>{Math.max(m3s.value, 0).toFixed(4)}</b> m³/s</span>
        </div>

        <div>
          <span>m³/min (Kubikmeter/Minute)</span>
          <span><b>{Math.max(m3s.value * 60, 0).toFixed(4)}</b> m³/min</span>
        </div>

        <div>
          <span>m³/h (Kubikmeter/Stunde)</span>
          <span><b>{Math.max(m3s.value * 3600, 0).toFixed(2)}</b> m³/h</span>
        </div>
