...
export const head: DocumentHead = {
  ...
  meta: [
    {
      name: "description",
      content: "Berechnet den erforderlichen Pumpendruck nach der Hazen-Williams-Gleichung.",
    },
  ],
}
...
export default component$(() => {
  ...
  return (
     <div class={styles.tool}>
      ...
      <p>Dieser Rechner verwendet die Hazen-Williams-Gleichung, um den erforderlichen Pumpendruck für eine gewisse Fördermenge zu berechnen.</p>
      ...
      <div class={styles.result}>
        ...
        <div>
          ...
          <span><b>{Math.max(mWs.value, 0).toFixed(2)}</b> mWs</span>
        </div>

        <div>
          <span>Bar</span>
          <span><b>{Math.max(mWs.value * 0.0980665, 0).toFixed(2)}</b> bar</span>
        </div>
