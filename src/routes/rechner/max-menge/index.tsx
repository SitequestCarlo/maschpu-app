...
export const head: DocumentHead = {
  ...
  meta: [
    {
      name: "description",
      content: "Berechnet die maximale Fördermenge basierend auf verschiedenen Parametern.",
    },
  ]
}
    ...
    <div class={styles.tool}>
      ...
      <div class={styles.result}>
        ...
        <div>
          ...
          <span><b>{Math.max(m3s.value, 0).toFixed(2)}</b> m³/s</span>
        </div>
        ...
        <div>
          ...
          <span><b>{Math.max(m3s.value * 1000 * 60, 0).toFixed(2)}</b> l/min</span>
        </div>
